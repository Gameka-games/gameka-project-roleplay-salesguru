Shader "VacuumShaders/Curved World/Terrain/Standard" 
{
	Properties 
	{
	...
	Dependency "AddPassShader" = "Hidden/VacuumShaders/Curved World/Terrain/Standard-AddPass"  
	Dependency "BaseMapShader" = "Hidden/VacuumShaders/Curved World/Terrain/Standard-Base" 

	Fallback "VacuumShaders/Curved World/Terrain/Diffuse" 
}
