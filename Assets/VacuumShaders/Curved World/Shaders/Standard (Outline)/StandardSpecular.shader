Shader  "VacuumShaders/Curved World/Outline/U5 Standard/Standard (Specular setup)"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="CurvedWorld_Opaque" 
			   ...
			   "CurvedWorldTag"="Outline/Standard (Specular setup)" 
			   "CurvedWorldNoneRemoveableKeywords"="" 
			   "CurvedWorldAvailableOptions"="V_CW_OUTLINE;V_CW_VERTEX_COLOR;V_CW_RIM;" 
			 }
		LOD 300
